  ...
  return (
    <>
      ...
      <div className=" w-full fixed top-0 left-0  z-10">
        <div className="md:flex justify-between md:justify-between lg:justify-between 2xl:justify-center items-center text-gray-100 bg-pink-600 backdrop-blur-lg backdrop-filter bg-opacity-30 lg:bg-transparent  py-0 md:py-0 lg:py-0 px-0 md:px-5 lg:px-20 2xl:mx-auto 2xl:container">
          ...
          <div
            ...
            className={`text-3xl absolute right-8 top-4 md:top-2 cursor-pointer lg:hidden p-[6px] rounded-xl text-white  ${open ? "bg-red-500" : "bg-gray-500"} `}
          >
